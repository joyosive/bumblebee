...
const DEFAULT_MARKERS = [
  ...
  { lat: 33.87, lng: -6.88, label: "Rabat" },
  { lat: -25.75, lng: 28.19, label: "Pretoria" },
  { lat: 5.56, lng: -0.19, label: "Accra" },
  // Asia
...
const DEFAULT_CONNECTIONS = [
  // EPFL hub connections
  { from: [46.52, 6.63], to: [9.03, 38.74] },
  { from: [46.52, 6.63], to: [-1.29, 36.82] },
  { from: [46.52, 6.63], to: [6.52, 3.38] },
  { from: [46.52, 6.63], to: [28.61, 77.21] },
  { from: [46.52, 6.63], to: [-23.55, -46.63] },
  { from: [46.52, 6.63], to: [14.69, -17.44] },
  { from: [46.52, 6.63], to: [33.87, -6.88] },
  // Africa network
  { from: [9.03, 38.74], to: [-1.29, 36.82] },
  { from: [-1.29, 36.82], to: [-6.17, 35.74] },
  { from: [6.52, 3.38], to: [5.56, -0.19] },
  { from: [-1.29, 36.82], to: [-25.75, 28.19] },
  { from: [14.69, -17.44], to: [33.87, -6.88] },
  // Asia network
  { from: [28.61, 77.21], to: [13.76, 100.50] },
  { from: [13.76, 100.50], to: [1.35, 103.82] },
  { from: [1.35, 103.82], to: [14.60, 120.98] },
  { from: [1.35, 103.82], to: [-33.87, 151.21] },
  // Americas network
  { from: [-23.55, -46.63], to: [4.71, -74.07] },
  { from: [4.71, -74.07], to: [19.43, -99.13] },
  { from: [4.71, -74.07], to: [-12.05, -77.04] },
  // Cross-continental
  { from: [51.51, -0.13], to: [19.43, -99.13] },
  { from: [6.52, 3.38], to: [-23.55, -46.63] },
...
export function InteractiveGlobe({
  className,
  size = 600,
  dotColor = "rgba(217, 119, 6, ALPHA)",
  arcColor = "rgba(245, 158, 11, 0.4)",
  markerColor = "rgba(245, 158, 11, 1)",
